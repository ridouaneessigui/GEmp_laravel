    ...
    <div id="app" >
        <nav class="navbar navbar-expand-md navbar-light navbar-laravel bg-dark">
            <div class="container" >
                ...
                @if(Auth::user())
                <li> <a href="{{url('projet/create')}}" style="font-size: 22px;color: #fff;padding-left: 22px">créer un projet </a>
                    
                </li>
                <li> <a href="{{url('Employeur/create')}}" style="font-size: 22px;color: #fff;padding-left: 22px"> créer un emop</a>
                ...
                @endif
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('login') }}" style="color: #fff">{{ __('connexion') }}</a>
                            </li>
                            <li class="nav-item">
                                @if (Route::has('register'))
                                    <a class="nav-link" href="{{ route('register') }}" style="color: #fff">{{ __('inscrire') }}</a>
                                @endif
                            </li>
                        @else
